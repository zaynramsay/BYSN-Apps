  ...
  sections: [
    ...
    // ─── 1. DATA STORAGE ───
    {
      ...
      subsections: [
        ...
        {
          title: '1.2 iCloud (One Integer, User-Controlled)',
          content: [
            {
              type: 'text',
              content:
                'The App syncs <strong>one data point</strong> to iCloud: a counter tracking how many times you\'ve shared the App (used for feature unlocks). This is a single integer sent via Apple\'s <code>NSUbiquitousKeyValueStore</code>. No birthday data, contact information, or personal details are synced.',
            },
            {
              type: 'text',
              content: '<strong>Opt out:</strong> iOS Settings > [Your Name] > iCloud > Cake > Toggle OFF.',
            },
          ],
        },
      ],
    ...
    // ─── 10. CONTACT ───
    {
      ...
      content: [
        {
          type: 'text',
          content: 'Questions about this policy or your data:<br /><strong>Email:</strong> <a href="mailto:bysnapps@gmail.com" style="color: #fc3d4f;">bysnapps@gmail.com</a><br /><strong>Website:</strong> <a href="https://www.bysnapps.com" style="color: #fc3d4f;">bysnapps.com</a>',
        },
        {
          type: 'text',
